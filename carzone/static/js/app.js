...
$(function () {
    ...
    'use strict';
    const blackLogoUrl = "static/img/logos/black-logo.png";
    const logoUrl = "static/img/logos/logo.png";
    const banner1Url = "static/img/banner/banner-1.jpg"
    ...
    $(document).ready(function () {
        $(".player").mb_YTPlayer(
            {
                mobileFallbackImage: banner1Url
            }
        );
    });
